...
See the [project environment](./guides/project_structure.md) documentation
for more details.
...
See the documentation on [managing dependencies](./guides/dependencies.md) for more
details.
...
!!! note
    ...
    by default. See [handling of extraneous packages](./guides/sync.md#handling-of-extraneous-packages)
    for details.
...
Check [Docker Usage](./guides/docker.md) for guidance on using uv with Docker.