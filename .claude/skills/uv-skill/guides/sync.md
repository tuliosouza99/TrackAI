...
[lockfile](./project_structure.md#the-lockfile). Syncing is the process of installing a subset of packages from
the lockfile into the [project environment](./project_structure.md#the-project-environment).
